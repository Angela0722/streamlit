...
choropleth_data=pd.DataFrame({
    "country":["Nigeria","Ghana","Togo","Benin","Senegal","Cameroon","Congo","canada","Russia","china"],
    "value":[10,20,30,40,50,60,70,80,90,85]})
st.title("Choropleth Map For Country")                            
st.write(choropleth_data)
st.text("Choropleth map visualization geographical data.")
